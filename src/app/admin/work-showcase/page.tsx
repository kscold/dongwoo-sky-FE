...
import { 
  ...
  useToggleWorkShowcaseActive 
} from "../../../common/hooks/useWorkShowcases"
...
const AdminWorkShowcasePage: React.FC = () => {
  ...
  const { data: workShowcasesData, isLoading } = useWorkShowcases(page, ITEMS_PER_PAGE)
  ...
  return (
    <div className={commonStyles.container}>
      <div className={commonStyles.header}>
        ...
        <Link href="/admin/work-showcase/create" className={commonStyles.actionButton}>
              ...
              <tr key={`${showcase._id}-${index}`}>
                ...
                <td className={commonStyles.tableCell}>
                  <div className={commonStyles.statusContainer}>
                    <span className={showcase.isActive ? commonStyles.publishedBadge : commonStyles.unpublishedBadge}>
                    ...
                    <label className={commonStyles.toggle}>
                      <input 
                        ...
                        onChange={() => handleToggleActive(showcase._id, showcase.isActive)}
                        className={commonStyles.toggleInput}
                      />
                      <span className={`${commonStyles.slider} ${showcase.isActive ? commonStyles.sliderChecked : ""}`}></span>
                    </label>
                  </div>
                </td>
                <td className={commonStyles.tableCell}>
