...
import { useCustomerReview } from "@/common/hooks/useCustomerReview"

export default function ContentAdminPage() {
  const [activeTab, setActiveTab] = useState<"work" | "review">("work")

  const { data: topWorkShowcases } = useWorkShowcase()
  const { data: topCustomerReviews } = useCustomerReview()
  const { data: workShowcases } = useWorkShowcase(1, 10)
  const { data: customerReviews } = useCustomerReview(1, 10)
