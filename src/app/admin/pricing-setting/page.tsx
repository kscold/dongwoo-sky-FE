...
import { usePricingSetting, useUpdatePricingSetting } from "@/common/hooks/usePricingSettings"
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                {saveStatus === 'error' && (
                    <div className={styles.errorMessage}>❌ 저장 중 오류가 발생했습니다.</div>
                )}
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <input
                            {...register("mainTitle", { required: "메인 제목은 필수입니다." })}
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <textarea
                            {...register("mainSubtitle", { required: "메인 부제목은 필수입니다." })}
                        ...
                        />
                        {errors.mainSubtitle && (
                            <p className={styles.errorMessage}>{errors.mainSubtitle.message}</p>
                        )}
                    </div>
                </div>
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.formRow}>
                        <div className={styles.formGroup}>
                            ...
                            <input
                                {...register("discountBannerTitle", { required: "할인 배너 제목은 필수입니다." })}
                                className={styles.input}
                                placeholder="예: 직접 문의 시 특별 할인!"
                                disabled={isSubmitting}
                            />
                            {errors.discountBannerTitle && (
                                <p className={styles.errorMessage}>{errors.discountBannerTitle.message}</p>
                            )}
                        </div>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            {errors.discountPercentage && (
                                <p className={styles.errorMessage}>{errors.discountPercentage.message}</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <input
                            {...register("discountBannerSubtitle", { required: "할인 배너 부제목은 필수입니다." })}
                            className={styles.input}
                            placeholder="예: 온라인 견적 대비 최대 5% 추가 할인 혜택"
                            disabled={isSubmitting}
                        />
                        {errors.discountBannerSubtitle && (
                            <p className={styles.errorMessage}>{errors.discountBannerSubtitle.message}</p>
                        )}
                    </div>
                </div>
