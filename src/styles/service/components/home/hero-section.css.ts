...
export const heroContent = style({
  ...
  paddingBottom: "4vh", // 하단 여백을 줄여서 인디케이터 공간 확보
  "@media": {
    "(max-width: 768px)": {
      padding: vars.space.md,
      maxWidth: "100%",
      paddingTop: "3vh",
      paddingBottom: "6vh", // 모바일에서 더 큰 하단 여백
    },
    "(max-width: 480px)": {
      padding: vars.space.sm,
      paddingTop: "2vh",
      paddingBottom: "8vh", // 더 큰 하단 여백으로 플로팅 버튼과 여유 간격
    },
  },
})
...
export const heroButtonContainer = style({
  ...
  gap: vars.space.md,
  alignItems: "center",
  marginBottom: "3rem", // 인디케이터와의 간격을 더 넉넉하게 (기존 2rem)
  "@media": {
    "(min-width: 640px)": {
      flexDirection: "row",
      justifyContent: "center",
      marginBottom: "3.5rem", // 데스크톱에서 더 큰 간격 (기존 2.5rem)
    },
    "(max-width: 768px)": {
      marginBottom: "2.5rem", // 태블릿에서 적당한 간격 (기존 1.8rem)
    },
    "(max-width: 480px)": {
      gap: vars.space.sm,
      width: "100%",
      marginBottom: "2rem", // 모바일에서 적당한 간격 (기존 1.5rem)
    },
  },
})
...
export const scrollIndicator = style({
  ...
  maxWidth: "200px",
  margin: "0 auto",
  paddingBottom: vars.space.xl, // 하단 여백 증가
  ...
  "@media": {
    ...
    "(max-width: 768px)": {
      fontSize: "0.85rem",
      gap: "0.6rem",
      paddingBottom: "3rem", // 모바일에서 상담 문의 버튼과의 안전한 간격
    },
    "(max-width: 480px)": {
      fontSize: "0.8rem",
      gap: "0.5rem",
      paddingBottom: "3.5rem", // 좀 더 큰 간격으로 버튼과 절대 겹치지 않게
    },
    "(max-width: 360px)": {
      fontSize: "0.75rem",
      paddingBottom: "4rem", // 가장 작은 화면에서 최대 간격
    },
  },
})
